...
<body>
	...
	<div class="container">
		...
		<form method="POST" id="registration" action="controller/RegistrationCtrl.php" enctype="multipart/form-data">
			<input type="hidden" name="h_id" value="<?=$fk_student_id;?>">
			<input type="hidden" name="h_photo" value="<?=$profile_pic;?>">
			<input type="hidden" name="h_username" value="<?=$u_name;?>">
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="input-group mb-3">
						...
						<input type="text" name="f_name" class="form-control" id="f_name" placeholder="First Name" value="<?=$f_name?>">
					</div>
				</div>
				<div class="col-md-3"></div>
				<div class=" col-md-3 r">
				...
				<div class="col-md-6">
					<div class="input-group mb-3">
						...
						<input type="text" name="l_name" class="form-control" id="l_name" placeholder="Last Name" value="<?=$l_name?>">
					</div>
				</div>
				<div class="col-md-3"></div>
				<div class=" col-md-3 r">
				...
				<div class="col-md-5">
					<div class="input-group mb-3">
						...
						<input type="file" name="profile_pic" class="form-control" id="profile_pic" onchange="preview()">
					</div>
				</div>
				<div class="col-md-1">
  					<img id="frame" src="uploads/<?=$profile_pic;?>" width="50px" height="50px"/>
					<!-- <img src="uploads/<?=$profile_pic;?>" style="height: 50px;"> -->
				</div>
				<div class="col-md-3"></div>
				<div class=" col-md-3 r">
				...
				<div class="col-md-6">
					<div class="input-group mb-3">
						...
						<input type="text" name="u_name" class="form-control" id="u_name" placeholder="Username" value="<?=$u_name?>">
					</div>
				</div>
				<div class="col-md-3"></div>
				<div class=" col-md-3 r">
				...
				<div class="col-md-6">
					<div class="input-group mb-3">
						...
						<input type="password" name="psw" class="form-control" id="psw" placeholder="Password" value="<?=$password?>">
					</div>
				</div>
				<div class="col-md-3"></div>
				<div class=" col-md-3 r">
				...
				<div class="col-md-6">
					<div class="input-group mb-3">
						...
						<input type="password" name="c_psw" class="form-control" id="c_psw" value="<?=$password?>" placeholder="Confirm Password">
					</div>
				</div>
				<div class="col-md-3"></div>
				<div class=" col-md-3 r">
				...
				<div class="col-md-6">
					<div class="input-group mb-3">
						...
						<input type="email" name="email" class="form-control" id="email" placeholder="E-Mail Address" value="<?=$email?>">
					</div>
				</div>
				<div class="col-md-3"></div>
				<div class=" col-md-3 r">
				...
				<div class="col-md-6">
					<div class="input-group mb-3">
						...
						<input type="number" name="c_no" class="form-control" id="c_no" placeholder="(639)" value="<?=$phone?>">
					</div>
				</div>
				<div class="col-md-3"></div>
