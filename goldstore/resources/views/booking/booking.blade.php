...
@section('script')
	...
	{!! Html::script('public/assets/pages-js/booking.js') !!}
	<script>
...
<div class="card">
	<div class="card-body">
		...
		<hr/>
		{{ Form::open(array('url' => 'insert-booking', 'id' => 'bookingForm')) }}
			...
			<div class="form-row">
					...
					<div class="row">
						<div class="col-md-3 col-sm-3 col-lg-3">
							<div class="form-group">
								...
								<input class="form-control booking_no" type="hidden" value="{{$data['booking_no'][0]['booking_no']}}" name="booking_no">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-md-3 mb-3 gold-weight-fg">
					...
					<div class="input-group mb-3">
						...
						<input type="text" class="form-control number-validate rate" name="ammount_gram" value={{ $data['sale']['sale_rate'] }}>
						<div class="input-group-append">	<span class="input-group-text">/gm</span>
						</div>
					</div>
				</div>
