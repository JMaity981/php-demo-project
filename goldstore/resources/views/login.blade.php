...
<body class="bg-login">
				...
				<div class="col-12 col-lg-10 mx-auto">
					<div class="card radius-15">
						<div class="row no-gutters">
							<div class="col-lg-6">
								{{ Form::open(array('url' => 'login-auth' , 'id' => 'login' , 'autocomplete' => 'off')) }}
									<div class="card-body p-md-5">
										...
										<div class="form-group mt-4">
											...
											<input type="text" class="form-control" name="loginemail" placeholder="Enter your email address" value="{{Cookie::get('username')}}" />
										</div>
										<!--<div class="form-group">
											<label>Password</label>
											<input type="password" class="form-control" name="loginpassword" placeholder="Enter your password" value="{{Cookie::get('password')}}" />
										</div>-->
										<div class="form-group">
											<label>Password</label>
											<div class="input-group" id="show_hide_password">
												<input class="form-control border-right-0" type="password" value="{{Cookie::get('password')}}" placeholder="Enter your password" name="loginpassword">
	...
	{!! Html::script('public/assets/js/pace.min.js') !!}
	...
	{!! Html::script('public/assets/pages-js/Login.js') !!}
