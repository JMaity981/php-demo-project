...
{!! Html::script('public/assets/plugins/edittable/bstable.js') !!}
{!! Html::script('public/assets/pages-js/Transection.js') !!}
<script>
    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <hr/>
                @include('common.commonProprietorDetails')
            </div>
        </div>
        {{----------Exchange Part----------}}
        <div class="card">
            <div class="card-body">
                ...
                {{ Form::open(array('url' => 'insert-exchange', 'id' => 'exchange_form')) }}
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <input type="hidden" class="from-control hiddenlager" name="hidden" value="{{$lageridval}}">
                    <input type="hidden" class="from-control is_booking" name="is_booking" value="{{$bookingidval}}">
                    <div class="col-md-2 col-sm-2 col-lg-2">
                        <label for="validationCustom03">Sale Purchase Type:</label><br>
                        <div class="wraper">
                            <input type="radio" name="select_type" class="select_type" id="s_id" value="S" {{$salecheck}}>
                            <input type="radio" name="select_type" class="select_type" id="p_id" value="P" {{$purchasecheck}}>
                    ...
                    <div class="col-md-2 col-sm-2 col-lg-2">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control  p_rate" type="text" placeholder="Purchase Rate"
                                name="purchase_rate" id="p_id" value="{{$purchaserateval}}">
                            <div class="input-group-append"><span class="input-group-text">/gm</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2 col-sm-2 col-lg-2">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control g_w reset" name="gold"
                                placeholder="Enter Gold Weight" value="{{$weightval}}">
                            <div class="input-group-append"><span class="input-group-text">gm</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control border-left-0 reset" name="t_amount"
                                placeholder="Enter Gold Weight" value="{{$amountval}}" id="amount_id">
                        </div>
                    </div>
                    <div class="col-md-2 mb-2">
                    ...
                    <div class="col-md-10 col-sm-10 col-lg-10">
                        ...
                        <div class="input-group">
                            ...
                            {{-- <textarea class="form-control" name="remark" rows="1"></textarea> --}}
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-1 col-lg-1">
                        <div class="form-group ">
                            ...
                            {{-- <input type="checkbox" id="gst_bill_id" >
