...
class BSTable {
      ...
      advanced: {                     // Do not override advanced unless you know what youre doing
          ...
          buttonHTML: `<div class="btn-group pull-right">
                <button id="bEdit" type="button" class="btn btn-sm btn-primary">
                    <span><i class="fadeIn animated bx bx-pencil"></i> </span>
                </button>
                <button id="bAcep" type="button" class="btn btn-sm btn-primary" style="display:none;">
                    <span><i class="fadeIn animated bx bx-save"></i> </span>
                </button>
            </div>`
      }
    };
  ...
  // Indicate user is editing the row
    ...
    this._modifyEachColumn(this.options.editableColumns, $cols, function($td) {  // modify each column
      ...
      var input = '<input class="form-control input-sm test" data-original-value="' + content + '" value="' + content + '">';
  ...
  // Accept the changes to the row
    ...
    this._modifyEachColumn(this.options.editableColumns, $cols, function($td) {  // modify each column
	  ...
	  var weight = $td.prev().find('input').val();
	  var finegold = $td.next().html();
	  var id = $td.parent('tr').find('th').find('input').val();
	$.ajax({
		...
		data:{cont:cont , weight:weight , finegold:finegold , id:id},
		dataType: 'json',
