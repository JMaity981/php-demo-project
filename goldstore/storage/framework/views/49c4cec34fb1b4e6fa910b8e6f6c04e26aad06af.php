            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown dropdown-user-profile">
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;" data-toggle="dropdown">
                        <div class="media user-box align-items-center">
                            <div class="media-body user-info">
                                <p class="user-name mb-0 text-white"><?php echo e(Session::get('username')); ?></p>
                    ...
                    <div class="dropdown-menu dropdown-menu-right">	
						<a class="dropdown-item" href="<?php echo e(url('db-export')); ?>">
...
<div class="modal fade" id="chPswModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <?php echo e(Form::open(array('url' => 'change-password', 'id' => 'chPswForm'))); ?>
...
<?php /**PATH C:\xampp\htdocs\goldstore\resources\views/common/header.blade.php ENDPATH**/ ?>