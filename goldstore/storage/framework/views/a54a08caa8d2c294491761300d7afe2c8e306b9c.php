		...
		<div class="card radius-15 bg-voilet">
			<div class="card-body">
				<div class="d-flex align-items-center">
					<div>
						<h2 class="mb-0 text-white"><?php echo e($data[0]['cash_stock']); ?> </h2>
					</div>
...
<div class="col-md-6 col-lg-6 col-sm-6">
	<div class="card radius-15 bg-sunset">
		<div class="card-body">
			<div class="d-flex align-items-center">
				<div>
					<h2 class="mb-0 text-white"><?php echo e($data[0]['fine_stock']); ?></h2>
				</div>
...
<div class="col-md-6 col-lg-6 col-sm-6">
	<div class="card radius-15 bg-danger">
		<div class="card-body">
			<div class="d-flex align-items-center">
				<div>
					<h2 class="mb-0 text-white"><?php echo e($data[0]['alloy_parchan']); ?></h2>
				</div>
				<div class="ml-auto font-35 text-white"><i class="fadeIn animated bx bx-coin"></i>
				</div>
			</div>
...
<div class="col-md-6 col-lg-6 col-sm-6">
	<div class="card radius-15 bg-info">
		<div class="card-body">
			<div class="d-flex align-items-center">
				<div>
					<h2 class="mb-0 text-white"><?php echo e($data[0]['alloy_gold']); ?></h2>
				</div>
				<div class="ml-auto font-35 text-white"><i class="fadeIn animated bx bx-coin"></i>
				</div>
			</div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\goldstore\resources\views/openingBalance/renderOpeningBalanceList.blade.php ENDPATH**/ ?>