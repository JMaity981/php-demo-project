...
<?php $__env->startSection('script'); ?>
    ...
    <?php echo Html::script('public/assets/pages-js/OpeningBalance.js'); ?>
                ...
                <div class="col-md-4 col-lg-4 col-sm-12">
                    <div class="card border-lg-top-primary">
                        <div class="card-body frm-loader">
                            ...
                            <hr />
                            <?php echo e(Form::open(['url' => 'add-opening-balance', 'id' => 'addstock'])); ?>
    ...
    <div class="modal fade" id="modalQuickView" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-sm modal-notify" role="document">
            <div class="modal-content text-center">
				<?php echo e(Form::open(['id' => 'edit_modal'])); ?>
...
<?php echo $__env->make('common.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\goldstore\resources\views/openingBalance/openingBalance.blade.php ENDPATH**/ ?>