...
<table width="100%" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<?
			   $query_sel_u="select * from `category` where cat_id='$_REQUEST[cat_id]'";
			...
			?>
                                  ...
                                  <tr>
									...
									<form name="frm" id="frm" method="post" action="includes/edit_cat_process.php?cat_id=<?=$res_u['cat_id']?>" enctype="multipart/form-data">
									  <span class="odd">
                                      ...
                                      <tr>
										...
										<tr>
                                           ...
                                           <td width="82%" height="27" align="left" class="odd"><input name="cat_name" type="text" id="cat_name" class="validate[required]" style="width:200px" value="<?= $res_u['cat_name'] ?>"/></td>
                                        </tr>
										 
										
									   <tr>
                                        <td class="odd">&nbsp;</td>
                                        <td height="27" align="left" class="odd">&nbsp;<input name="Add Plan" type="submit" value="Update" onclick="return Go();" />&nbsp;<input name="Cancel" type="reset" value="Reset" />&nbsp;<input name="back" type="button" value="Back" onclick="window.location='index.php?module=category&&header=Category'" /></td>
                                      </tr>
                                      <tr>
