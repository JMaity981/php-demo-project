		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="4" cellpadding="0">
                                  ...
                                  <tr>
									...
									<form name="frm" id="frm" method="post" action="includes/cat_add_process.php?security_code=<?=$_SESSION['security_code'];?>" enctype="multipart/form-data">
                                      ...
                                      <tr>
                                        ...
                                        <td height="27" colspan="2" class="subtabs"><span class="column_heading">&nbsp;</span></td>
										  ...
										  <tr>
                                           ...
                                           <td width="82%" height="27" align="left" class="odd"><input name="cat_name" type="text" id="cat_name" class="validate[required]" style="width:200px" value=""/></td>
                                         </tr>
                                         								   <tr>
                                        <td class="odd">&nbsp;</td>
