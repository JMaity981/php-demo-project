...
<?php 
								$var="SELECT * FROM  advertisement WHERE `id`='1'";
								$rs1=mysql_query($var);
								$rs=mysql_fetch_array($rs1);
                                        ?>                                  <tr>
                                    <td width="50%" align="left" valign="top">
									<form name="frm" id="frm" method="post" action="includes/advertisement_add_process.php?id=<?=$rs['id']?>" enctype="multipart/form-data">
									<table  class="grid" width="100%" align="center" cellpadding="6" cellspacing="1">
                                      <tr>
                                        ...
                                        <td height="27" colspan="2" class="subtabs"><span class="column_heading">&nbsp;</span></td>
										  ...
										  <tr>
                                           <td width="18%" class="odd">&nbsp;Advertisement Image(200*337)<font color="#FF0000">*</font>:</td>
                                           <td width="82%" height="27" align="left" class="odd"><input name="image" type="file" id="image" class="validate[required]" style="width:200px" value=""/>
                                          
                                            <img src="upload/<?=$rs['image']?>" width="50" height="50" /></td>
                                           </td>
                                         </tr>
                                         								   <tr>
                                        <td class="odd">&nbsp;</td>
                                        <td height="27" align="left" class="odd">&nbsp;<input name="Add Plan" type="submit" value="submit" onclick="return Go();" />&nbsp;<input name="Cancel" type="reset" value="Reset" />&nbsp;<input name="back" type="button" value="Back" onclick="window.location='index.php?module=category&&header=Category'" /></td>
                                      </tr>
                                      <tr>
