...
<table width="100%" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<?
			   $query_sel_u="select * from `color` where id='$_REQUEST[id]'";
			...
			?>
                                  ...
                                  <tr>
									...
									<form name="frm" id="frm" method="post" action="includes/edit_color_process.php?id=<?=$res_u['id']?>" enctype="multipart/form-data">
									  <span class="odd">
                                      ...
                                      <tr>
										...
										<tr>
                                           ...
                                           <td width="82%" height="27" align="left" class="odd"><input name="clour_name" type="text" id="clour_name" class="validate[required]" style="width:200px" value="<?= $res_u['clour_name'] ?>"/></td>
                                        </tr>
										 <tr>
                                           <td width="18%" class="odd">&nbsp;Color Image(25*20)<font color="#FF0000">*</font>:</td>
                                           <td width="82%" height="27" align="left" class="odd"><input name="image1" type="file" id="image1" style="width:200px"/>
                                           <input name="himage1" type="hidden" id="himage1" style="width:200px" value="<?=$res_u['color_image'] ?>"/>
                                             <img src="upload/<?=$res_u['color_image']?>" width="30" height="30" /></td>
                                        </tr>
										
									   <tr>
                                        <td class="odd">&nbsp;</td>
                                        <td height="27" align="left" class="odd">&nbsp;<input name="Add Plan" type="submit" value="Update" onclick="return Go();" />&nbsp;<input name="Cancel" type="reset" value="Reset" />&nbsp;<input name="back" type="button" value="Back" onclick="window.location='index.php?module=color&&header=Color'" /></td>
                                      </tr>
                                      <tr>
