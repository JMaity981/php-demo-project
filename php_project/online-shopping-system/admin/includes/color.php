...
<table width="100%" cellpadding="0" cellspacing="0">
			<tbody>
				<tr>
					...
					<td class="drawtab_header" valign="middle">Manage Color</td>
                                  ...
                                  <tr>
                                    <td width="100%" colspan="2" align="left" valign="top"><table class="grid" width="100%" align="center" cellpadding="6" cellspacing="1">
                                      ...
                                      <tr>
										...
										<td class="subtabs" align="center"><a href="#" class="column_heading">Colar Name</a></td>
										...
										$query_sel_u="select * from `color` order by `id` desc LIMIT $offset, $rowsPerPage";
                                      ...
                                      <tr>
										...
										<td width="16%" align="center" class="odd"><?=$array_sel_u['clour_name'];?></td>
										
								
										
										<td width="11%" height="27" align="center" valign="middle" class="odd"><? if($array_sel_u[status]=='0'){?><a href="includes/active_color.php?id=<?=$array_sel_u['id'];?>&&action=active" title="Click to active"><img src="images/active_off.gif" alt="Edit" width="16" height="16" border="0" /></a><? } else { ?><a href="includes/active_color.php?id=<?=$array_sel_u['id'];?>&&action=inactive" title="Click to Inactive"><img src="images/active_on.gif" alt="Edit" width="16" height="16" border="0" /></a>
									    <? }?></td>
                                        <td width="4%" height="27" align="center" valign="middle" class="odd"><a href="index.php?module=edit_color&header=Edit&id=<?=$array_sel_u['id']?>"><img src="images/edit.gif" title="Edit" width="16" height="16" border="0" /></a></td>
                                        <td width="7%" align="center" valign="middle" class="odd"><a href="#" onclick="javascript:if(confirm('Do you want to delete?')){window.location='includes/delete_color.php?id=<?=$array_sel_u['id'];?>'}"><img src="images/delete.gif" title="Delete" width="16" height="16" border="0" /></a></td>
                                      </tr>
									  <?
									  $i++; } ?>
									  <? 
										...
										for($page = 1; $page <= $maxPage; $page++)
										{
											...
											{
												$nav .= " <a href=\"$self?page=$page&module=color&header=Color\">$page</a> ";
											}		
										}
									...
									{
										$page = $pageNum - 1;
										$prev = " <a href=\"$self?page=$page&module=color&&header=Color\" class=\"style1\"><< Back</a> ";
									...
									{
										$page = $pageNum + 1;
										$next = " <a href=\"$self?page=$page&module=color&&header=Color\" class=\"style1\">Next >></a> ";
