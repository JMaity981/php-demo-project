...
<div class="wrap">
    ...
    <div class="featur_box containt">
        ...
        <?php
		$i=1;
		$qry="select * from product where status=1 and prod_name like '$keyword%'";
       ...
       <?php 
	   				$qry_string[1]="searchkey=".$_GET['searchkey'];
					
					$qry_pagi="select * from product where status=1 and prod_name like '$keyword%'";
		...
		echo "NO product found of on this keyword..";
		?>
