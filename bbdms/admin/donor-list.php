...
<head>
	...
	<link rel="shortcut icon" href="img/ts-avatar.jpg" />
...
{?>
<a style="color: green;"> Donate / </a> 
<?php } else {?>

<a style="color: red;" href="donor-list.php?public=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to change status')"> Pending / </a>
