...
?>
													...
													<div class="stat-panel-title text-uppercase">Listed Blood Donars</div>
												</div>
											</div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												...
												<?php
$x = '1';
$sql1 ="SELECT id from tblblooddonars where status:status";
$query1 = $dbh -> prepare($sql1);
$query1-> bindParam(':status', $x, PDO::PARAM_STR);
$query1->execute();
